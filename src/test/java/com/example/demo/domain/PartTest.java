...
class PartTest {
    ...
    @Test
    void testMaxInvIsGreaterThanMinInv() {
        int minInv = 5;
        int maxInv = 10;
        ...
        assertTrue("Max Inv should be greater than Min Inv for Inhouse Parts", partIn.getMaxInv() > partIn.getMinInv());
        assertTrue("Max Inv should be greater than Min Inv for Outsourced Parts", partOut.getMaxInv() > partOut.getMinInv());
    }

    @Test
    void testMinInvIsLessThanMaxInv() {
        int minInv = 10;
        int maxInv = 5;
        ...
        assertFalse(partIn.getMaxInv() > partIn.getMinInv(), "Max Inv should be greater than Min Inv for Inhouse Parts");
        assertFalse(partOut.getMaxInv() > partOut.getMinInv(), "Max Inv should be greater than Min Inv for Outsourced Parts");
    }
}